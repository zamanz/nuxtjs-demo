            ...
            <div class="col-md-12">
                <div class="card mt-3">
                    ...
                    <div class="card-body">
                        ...
                        <div class="my-3">{{ $auth.user }}</div>
                        <div>{{ $t('profile.content') }}</div>
                    </div>
            ...
            <div class="py-8">
                <div>
                    ...
                    <div class="mt-2">
                        ...
                        <div class="mt-4">
                            <input id="username" v-model="keyword" type="text" class="appearance-none border rounded w-full h-14 py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" placeholder="Search">
                        </div>
                    </div>
                </div>
                                ...
                                <tr v-for="(user, index) in users" :key="user.id">
                                    <td class="px-3 py-2 border-b border-gray-200 bg-white text-sm">
                                        <label class="inline-flex items-center">
                                            ...
                                            <input v-model="userIds" type="checkbox" class="form-checkbox w-4 h-4 text-green-600" :value="user.id" @change="selectUser">
                                        </label>
                                    </td>
                                    <td class="px-3 py-2 border-b border-gray-200 bg-white text-sm">
...
export default {
    ...
    data(){
     ...
     computed:{
        users(){
            const $this = this
            return this.$store.getters.getUsers.filter((item) =>{
                const queryText = $this.keyword;
                return (item.name.includes(queryText) || item.email.includes(queryText));
            });
        }
    },
